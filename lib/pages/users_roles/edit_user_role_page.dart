...
class EditUserRolePage extends StatefulWidget {
  ...
  @override
  _EditUserRolePageState createState() => _EditUserRolePageState();
}
...
class _EditUserRolePageState extends State<EditUserRolePage> {
  ...
  void initState() {
    ...
    _roleController.text = widget.argument['role'];
  }
            ...
            child: Padding(
              ...
              child: Padding(
                ...
                child: Container(
                  ...
                  child: FlatButton(
                    onPressed: () async {
                      if (await updateUserRoleToFirebase(
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                                content: Text("Update User Role Succesful!")));
                        tablesProvider.refreshFromFirebase(Tables.usersRoles);
                      } else {
                        ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                                content: Text("Update User Role failed!")));
                      }
                    },
                    child: Padding(
