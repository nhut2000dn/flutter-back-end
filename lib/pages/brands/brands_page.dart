                ...
                InkWell(
                  ...
                  onTap: () async {
                    ...
                    Widget continueButton = TextButton(
                      child: Text("Continue"),
                      onPressed: () async {
                        bool check = await _brandService.deleteBrand(row['id']);
                        if (check) {
                          tablesProvider.removeFromTable(Tables.brands, value);
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text("Delete Brand Succesful!"),
                            ),
                          );
                        }
                      },
                ...
                InkWell(
                  ...
                  onTap: () {
                    locator<NavigationService>()
                        .navigateToWithArgument(EditBrandRoute, row);
                  },
                ),
              ],
            );
              ...
              child: ResponsiveDatatable(
                ...
                actions: [
                  if (tablesProvider.isSearch)
                    DropdownButton(
                      itemHeight: 64,
                      value: tablesProvider.fieldBrandCurrent,
                      items: tablesProvider.fieldsBrand
                          .map(
                            ...
                            onPressed: () {
                              setState(
                                () {
                                  ...
                                  tablesProvider.resestData(Tables.brands);
                                },
                              );
                            },
                          ),
                          suffixIcon: IconButton(
                            ...
                            onPressed: () {
                              tablesProvider.onSearch(
                                  Tables.brands, inputSearchController.text);
                            },
                          ),
                        ),
                      ),
                ...
                footers: [
                  Container(
                    ...
                    child: Text(
                        "Number of brands: ${tablesProvider.brandsTableSource.length}"),
                  ),
                ],
              ),
            ),
